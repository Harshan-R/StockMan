...
import defaultLogo from "./nselogo.png";
...
const NseStockpage = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:8001/nse/${key}`)
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
        setStock(data);
    ...
    <>
      <div class="contentBx">
        <center>
          ...
          {user && <h3 className="stockname">Holding : {holding}</h3>}
          <div class="extock">
